  ...
  return (
    <main className="min-h-screen bg-[#0D0C11] text-white flex flex-col selection:bg-green-500/30">
      ...
      <div className="flex-1 flex items-center justify-center p-4 relative z-10 my-24">
        <div className="w-full max-w-lg bg-[#18171F] border border-white/5 p-10 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-white text-black px-6 py-5 rounded-2xl font-black text-lg hover:bg-green-600 hover:text-white transition-all transform active:scale-95 shadow-[0_10px_30px_rgba(255,255,255,0.1)] hover:shadow-[0_20px_50px_rgba(34,197,94,0.3)] mt-6 uppercase tracking-wider disabled:opacity-50 disabled:cursor-not-allowed"
            >
